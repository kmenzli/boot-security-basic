...
* The original package name 'com.training.boot.security.boot-security-basic' is invalid and this project uses 'com.training.boot.security.bootsecuritybasic' instead.
